...
- [ ] T013 [P] Create reusable partial at docs/_partials/isaac-installation.md for Omniverse and Isaac Sim setup
- [ ] T014 [P] Create reusable partial at docs/_partials/gpu-troubleshooting.md for CUDA/GPU driver issues
...
- [ ] T023 [P] [LJ1] Create USD scene at docs/assets/module-3/usd_scenes/warehouse_environment.usd
- [ ] T024 [P] [LJ1] Create USD humanoid robot at docs/assets/module-3/usd_scenes/humanoid_simple.usd
...
- [ ] T032 [P] [LJ1] Create Python script at docs/assets/module-3/code/chapter-3-3/add_camera_sensor.py
...
- [ ] T057 [P] [LJ2] Create Python script at docs/assets/module-3/code/chapter-3-4/export_coco_annotations.py
...
- [ ] T060 [P] [LJ2] Create Replicator script at docs/assets/module-3/code/chapter-3-4/randomization_script.py
...
- [ ] T064 [P] [LJ2] Create visualization script at docs/assets/module-3/code/chapter-3-4/visualize_annotations.py
...
- [ ] T076 [P] [LJ3] Create Docker setup script at docs/assets/module-3/code/chapter-3-5/isaac_ros_docker_setup.sh
...
- [ ] T086 [P] [LJ3] Create launch file at docs/assets/module-3/code/chapter-3-6/cuVSLAM_launch.py
...
- [ ] T092 [P] [LJ3] Create benchmark script at docs/assets/module-3/code/chapter-3-6/vslam_benchmark.py
...
- [ ] T097 [P] [LJ3] Create depth estimation example at docs/assets/module-3/code/chapter-3-6/depth_estimation.py
...
- [ ] T108 [P] [LJ4] Create Nav2 config file at docs/assets/module-3/code/chapter-3-7/humanoid_nav2_params.yaml
...
- [ ] T123 [P] [LJ4] Create integrated launch file at docs/assets/module-3/code/chapter-3-8/nav2_vslam_launch.py
...
- [ ] T134 [P] Create warehouse_patrol.usd scene at docs/assets/module-3/usd_scenes/
