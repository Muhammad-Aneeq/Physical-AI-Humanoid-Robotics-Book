...
class ContentIngester:
    ...
    def __init__(self, base_url: str = "https://muhammad-aneeq.github.io/Physical-AI-Humanoid-Robotics-Book"):
        """
...
async def main():
    ...
    parser.add_argument(
        "--base-url",
        type=str,
        default="https://muhammad-aneeq.github.io/Physical-AI-Humanoid-Robotics-Book",
