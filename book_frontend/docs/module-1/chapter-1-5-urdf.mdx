...
**URDF (Unified Robot Description Format)** is XML-based format describing robot morphology—geometry, kinematics, dynamics, sensors. Used by RViz2 (visualization), Gazebo (simulation), and controllers (motion planning). Essential for any robot system.
...
- **"Loop detected"**: URDF must be tree, not graph—break loops
