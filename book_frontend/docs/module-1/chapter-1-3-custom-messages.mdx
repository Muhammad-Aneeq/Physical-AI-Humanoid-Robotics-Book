...
- ✅ **Standard**: Data fits existing types (velocity commands use geometry_msgs/Twist, camera images use sensor_msgs/Image)
- ✅ **Custom**: Unique sensor combinations (temperature + humidity + pressure), application-specific data, no standard equivalent exists
